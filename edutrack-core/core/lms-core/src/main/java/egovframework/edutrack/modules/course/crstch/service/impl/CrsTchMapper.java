...
public interface CrsTchMapper {
	...
	public List<CrsTchVO> list(CrsTchVO VO)   ;
	 ...
	 * @return
	 */
	public CrsTchVO select(CrsTchVO VO)   ;
	 ...
	 * @reurn ProcessResultVO
	 */
	public int update(CrsTchVO VO)   ;

    /**
     * 과정 강사 정보의 복수의 레코드를 Update하고 결과를 반환한다.
     * @param List<WordDictCtgrVO>
     */
	public int updateBatch(List<CrsTchVO> itemArray)   ;
	 ...
	 * @reurn ProcessResultVO
	 */
	public int deleteAll(CrsTchVO VO)   ;
	...
	public List<UsrUserInfoVO> listSearch(CrsTchVO VO)   ;
