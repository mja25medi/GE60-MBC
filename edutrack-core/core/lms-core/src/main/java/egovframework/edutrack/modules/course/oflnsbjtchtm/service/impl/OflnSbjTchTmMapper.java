...
public interface OflnSbjTchTmMapper  {
	...
	public List<OflnSbjTchTmVO> list(OflnSbjTchTmVO VO)   ;
	 ...
	 * @return
	 */
	public OflnSbjTchTmVO select(OflnSbjTchTmVO VO)   ;
	 ...
	 */
	public int insert(OflnSbjTchTmVO VO)   ;
	 ...
	 * @reurn ProcessResultVO
	 */
	public int update(OflnSbjTchTmVO VO)   ;
	 ...
	 * @reurn ProcessResultVO
	 */
	public int delete(OflnSbjTchTmVO VO)   ;
	 ...
	 * @reurn ProcessResultVO
	 */
	public int deleteAll(OflnSbjTchTmVO VO)   ;
