...
public interface ClibCntsShareReqMapper {
	...
	public List<ClibCntsShareReqVO> list(ClibCntsShareReqVO vo)  ;
	 ...
	 * @return ProcessReslutListVO
	 */
	public ClibCntsShareReqVO select(ClibCntsShareReqVO vo)  ;
	 ...
	 */
	public int insert(ClibCntsShareReqVO vo)  ;
	 ...
	 * @return  ProcessResultVO
	 */
	public int update(ClibCntsShareReqVO vo)  ;
	 ...
	 * @return  ProcessResultVO
	 */
	public int delete(ClibCntsShareReqVO vo)  ;
	 ...
	 * @return  ProcessResultVO
	 */
	public int deleteCnts(ClibCntsShareReqVO vo)  ;
	 ...
	 * @return  ProcessResultVO
	 */
	public int rejectCnts(ClibCntsShareReqVO vo)  ;
	 ...
	 * @return  ProcessResultVO
	 */
	public int updateShareCd(ClibCntsShareReqVO vo)  ;
}
