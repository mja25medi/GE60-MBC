...
public interface ExamQstnMapper{
	...
	public List<ExamQuestionVO> list(ExamQuestionVO vo ) ;
	 ...
	 * @return
	 */
	public List<ExamQuestionVO> randList(ExamQuestionVO vo) ;
	 ...
	 * @return
	 */
	public ExamQuestionVO select(ExamQuestionVO vo ) ;
	/**
	 * Select Key 조회
	 * @param int
	 * @return
	 ...
	 * @return
	 */
	public int insert(ExamQuestionVO vo) ;
	 ...
	 * @return
	 */
	public int update(ExamQuestionVO vo) ;
	 ...
	 * @return
	 */
	public int updateScore(ExamQuestionVO vo) ;
	 ...
	 * @return
	 */
	public int delete(ExamQuestionVO vo) ;
	 ...
	 * @return
	 */
	public ExamQuestionVO selectMaxQstnNo(ExamQuestionVO vo) ;

	/**
	 * 시험문제의 고유번호 EXAM_QSTN_SN을 검색하여 결과롤 반환한다.
	 * @return
	 */
	public ExamQuestionVO selectExamQstnSn()  ;
	 ...
	 * @return
	 */
	public List<ExamQuestionVO> listPreview(ExamQuestionVO vo)  ;
	 ...
	 * @return
	 */
	public int forUpdate(ExamQuestionVO vo)  ;
	 ...
	 * @return
	 */
	public int updateSort(ExamQuestionVO vo)  ;

	/**
	 * 시험문제의 문제번호 EXAM_QSTN_NO을 검색하여 결과롤 반환한다.
	 * @return
	 */
	public ExamQuestionVO selectExamQstnNo(ExamQuestionVO vo)  ;
	 ...
	 * @return
	 */
	public int updateBatch(List<ExamQuestionVO> bannerArray) ;
