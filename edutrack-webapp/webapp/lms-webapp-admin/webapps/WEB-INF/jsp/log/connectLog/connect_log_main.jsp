			...
			<div class="row" id="content">
				<div class="col-md-12 col-sm-12">
					<div class="well well-sm">
						<form name="connectLogForm" onsubmit="return false" id="connectLogForm" method="POST" >
...
<script type="text/javascript">
	...
	function listStatus() {
	    var cmd = "/adm/connectLog/list";
	    $('#connectLogForm').attr("action", cmd);
		$('#connectLogForm').ajaxSubmit(processListStatusCallback);
	}
	...
	function dateSetter(str) {
		 var cmd = "/adm/connectLog/viewAutoDate";
		 $('#connectLogForm').attr("action", cmd);
		$('#connectLogForm').find('input[name=dateType]').val(str);
		$('#connectLogForm').ajaxSubmit(autoDateCallback);
	}

	function autoDateCallback(ProcessResultVO) {
		var Item = ProcessResultVO;
		$('#connectLogForm').find('input[name=startDt]').val(Item.startDt);
		$('#connectLogForm').find('input[name=endDt]').val(Item.endDt);
		listStatus();
	}
