...
<div style="width:96%;margin:0 auto;">
	...
	<table summary="<spring:message code="board.title.bbs.head.manage"/>" style="width:100%" class="table table-bordered">
		<colgroup>
...
<script type="text/javascript">
	...
	function addHead() {
		document.location.href = cUrl("/adm/brd/bbs/addHeadForm")+"?orgCd=${vo.orgCd}&bbsCd=${vo.bbsCd}";
	}

	function editHead(headCd) {
		document.location.href = cUrl("/adm/brd/bbs/editHeadForm")+"?orgCd=${vo.orgCd}&bbsCd=${vo.bbsCd}&headCd="+headCd;
	}
