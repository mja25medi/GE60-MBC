 ...
 **********************************************************************************************/
    ...
    /**
     * 데이터 유효성을 체크한다.
     * 2016.04.05 전자정부 프레임워크 적용하면서 변경
     * @param   form
     */
    function validate(form) {
        ...
        for (i = 0; i < form.elements.length; i++) {
            ...
            // 필수 입력 항목 체크
            if (obj.getAttribute("required") == "required" || obj.getAttribute("required") != null) {
                isValid = false;
            ...
            /*if(lenCheck != null)
            {
              if(jsByteLength(value) > eval(lenCheck))
                {
                  alert( getCommonMessage("msg012", dispName, lenCheck, jsByteLength(value)));
                  obj.focus();
                  if(window.event)
                    {
                       window.event.returnValue = false;
