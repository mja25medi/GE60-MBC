...
public class DecoratorController extends GenericController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/lecPop")
	public String lecPop(HttpServletRequest request , HttpServletResponse response) throws Throwable {

		String tplType = UserBroker.getUserLayoutTplType(request);
	
		
		return UserBroker.getPrefixHomeUrl(request)  + "decorators/pop_lec_decorator";
	}
	...
	public String pop2(HttpServletRequest request , HttpServletResponse response) throws Throwable {

		String tplType = UserBroker.getUserLayoutTplType(request);
	
		
		return UserBroker.getPrefixHomeUrl(request)  + "decorators/pop_decorator2";
	}
	/**
     * @Method Name : decorator
     * @Method 설명 : sitemesh 탬플릿 조회
	...
	public String tutor(HttpServletRequest request , HttpServletResponse response) throws Throwable {

		String tplType = UserBroker.getUserLayoutTplType(request);
	
		
		return UserBroker.getPrefixHomeUrl(request)  + "decorators/tutor_decorator";
	}
