...
<head>
	...
	<!-- Custom	CSS	-->
	<meditag:css href="tpl/${COLOR_TPL}/css/tpl_home.css"/>
	...
	<div id="wrap">
		...
		<div class="container repair">
			...
			<div class="col-md-9 subCon">
				<div class="sv m01" style="background:url(${headerBg});">
					<p class="sv_txt" style="background:url(/app/file/view2/${SUB_TXTIMGSN});background-size:cover;">${SUB_TXTSTR}</p>
				</div>
				<div id="content">
	    ...
	    <c:import url="/WEB-INF/jsp/tpl/home/${COLOR_TPL}/inc/quick_menu.jsp" charEncoding="UTF-8"/>
