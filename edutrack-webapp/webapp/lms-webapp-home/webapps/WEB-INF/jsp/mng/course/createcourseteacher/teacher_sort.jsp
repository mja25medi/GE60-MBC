...
<c:set var="teacherVO" value="${vo}"/>
	...
	<input type="hidden" name="tchType" value="${vo.tchType }" />
...
<script type="text/javascript">
	...
	function sortTeacher() {
		var f = document.createCourseTeacherForm;
		f["teacherVO.userNo"].value = "";
		...
		if(selectBox.length == 0) {
			...
			f["teacherVO.userNo"].value = userList;
