...
<mhtml:frm_body cssTag="background: #ffffff">
	...
	<table title="<spring:message code="course.message.tutor.manage"/>" style="width:100%" class="table_none">
    	<tr>
        	<td style="padding:5px 5px 5px 5px" width="65%" valign="top">
            	...
            	<c:forEach items="${tutorList}" var="item">
...
<script type="text/javascript">
	...
	function sortTeacher() {
		...
		if(selectBox.length == 0) {
			alert('<spring:message code="course.message.tutor.sort.nodata"/>');
		} else {
