							...
							<script type="text/javascript">
								...
								function searchCourse() {
									...
									var addContent  = "<iframe id='courseFrame' name='courseFrame' width='100%' height='100%' "
										+ "frameborder='0' scrolling='no' src='<c:url value="/mng/course/contents/listSearchCourseForm"/>"
										+ "?sbjNm="+sbjNm+"'/>";
									modalBox.clear();
								...
								function otherContentsList() {
									...
									.jstree({
										...
										"json_data" : {
											"ajax" : {
												"url" : "/mng/course/contents/listContentsJsonList",
												"data" : function (n) {
													return {
								...
								function goContents() {
									var url = cUrl("/mng/course/contents/viewCntsMain")+"?bookmarkVO.sbjCd="+ItemDTO.sbjCd+"${AMPERSAND}bookmarkVO.unitCd="+ItemDTO.unitCd;
