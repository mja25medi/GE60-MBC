							...
							<script type="text/javascript">
								$(document).ready(function() {
									$("#localFileTree").jstree({
										...
										"json_data" : {
											"ajax" : {
												"url" : "/mng/course/contents/listFile",
												"data" : function (n) {
													return {
														"sbjCd" : ItemDTO.sbjCd,
								...
								function addFile() {
									...
									var addContent  = "<iframe id='fileFrame' name='fileFrame' width='100%' height='100%' "
										+ "frameborder='0' scrolling='no' src='<c:url value="/mng/course/contents/addFormFilePop"/>"
										+ "?sbjCd="+ItemDTO.sbjCd+"&amp;filePath="+filePath+"&amp;fileId="+ItemDTO.fileId+"'/>";
									modalBoxChild.clear();
									modalBoxChild.addContents(addContent);
									modalBoxChild.resize(500, 220);
								...
								function addDir() {
									var addContent  = "<iframe id='fileFrame' name='fileFrame' width='100%' height='100%' "
										+ "frameborder='0' scrolling='no' src='<c:url value="/mng/course/contents/addFormDirPop"/>"
								...
								function fileRename() {
									var addContent  = "<iframe id='fileFrame' name='fileFrame' width='100%' height='100%' "
										+ "frameborder='0' scrolling='no' src='<c:url value="/mng/course/contents/renameFormFilePop"/>"
								...
								function fileDelete() {
									...
									$.getJSON( cUrl("/mng/course/contents/deleteFile"),	{
											sbjCd : ItemDTO.sbjCd,
											fileDir : fileName
										},  function	(resultDTO) {
								...
								function fileUnzip() {
									...
									if(ItemDTO.sbjCd != "" && ItemDTO.fileDir != "" && ItemDTO.fileName != "") {
										$.getJSON( cUrl("/mng/course/contents/unzipFile"),	{
												sbjCd : ItemDTO.sbjCd,
												fileDir : "/"+ItemDTO.fileDir,
								 ...
								 */
								function filePaste() {
									$.getJSON( cUrl("/mng/course/contents/pasteFile"),	{
											sbjCd : ItemDTO.sbjCd,
