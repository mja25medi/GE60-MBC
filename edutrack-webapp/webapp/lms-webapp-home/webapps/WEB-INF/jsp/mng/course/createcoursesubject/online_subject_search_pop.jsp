	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div id="sbjList" style="width:100%;min-height:300px;text-align:center;">
...
<script type="text/javascript">
	...
	function listSubject() {
		...
		$('#sbjList')
			.load(cUrl("/mng/course/createCourse/subject/listOnlineSearch"),
				{	
	...
	function addSubject(sbjCd, sbjType) {
		...
		$.getJSON( cUrl( "/mng/course/createCourse/subject/addOnlineSubject"),
				   { "crsCreCd" : ItemDTO.crsCreCd,"sbjCd" : sbjCd, "studyMthd":studyMthd, "sbjType": sbjType },			// params
				   function(data) {
						if(data.result >= 0) {
							//-- 정상 처리
