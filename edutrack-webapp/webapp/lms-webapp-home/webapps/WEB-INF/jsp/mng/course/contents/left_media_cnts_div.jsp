...
<%@ include file="/WEB-INF/jsp/mng/common/page_init.jsp" %>
							...
							<div id="shareBox" style="width:100%;margin-top:10px;">
								<form name="MediaSearch" class="form-inline">
   								<div class="input-group" style="width:40%;float:left;">
									...
									<input type="text" name="shareCtgrNm" id="shareCtgrNm" class="form-control input-sm" value="" onclick="clickDropdown()"/>
								</div>
								...
								<div id="shareContentsListArea" style="float:none;width:100%;height:642px;overflow:auto; border:2px solid #4FADBC;margin-top:6px;font-size:14px;"></div>
							</div>
							...
							<script type="text/javascript">
								...
								function searchShare() {
									...
									if(["VOD", "CDN","MLINK"].includes(cntsTypeCd)) {
										var url = cUrl("/mng/library/clibShareCnts/listMediaCntsForCntsMgr");										
