...
<mhtml:frm_body cssTag="background: #ffffff">
	...
	<table title="<spring:message code="course.title.subject.manage"/>" style="width:96%" class="table_none">
    	<tr>
...
<script type="text/javascript">
	...
	function sortSubject() {
		...
		if(selectBox.length == 0) {
			...
			f["crsOflnSbjVO.sbjCd"].value = sbjList;
