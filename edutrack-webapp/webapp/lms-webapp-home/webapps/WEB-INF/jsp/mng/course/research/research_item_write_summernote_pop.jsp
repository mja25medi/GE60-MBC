		...
		<tbody>
			...
			<tr>
				...
				<td colspan="4" style="padding:0px;font-family:${fontFamily}">
					<div id="summernote" style="float:left; width:100%; margin: 0 auto;">${researchBankItemVO.reshItemCts}</div>
...
<script type="text/javascript">
	...
	function addItem() {
		...
		if(document.researchBankForm["reshItemSn"].value != "0")
			$('#researchBankForm').attr("action","/mng/course/researchBank/editItem");
