		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="input-group" style="float:left;width:200px;">
						<input type="text" id="searchValue" name="searchValue" class="_enterBind form-control input-sm" maxlength="20"/>
...
<script type="text/javascript">
	...
	function listSubject() {
		...
		$('#sbjList')
			.load(cUrl("/mng/course/courseSubject/openCourselistOnlnSearch"),
				{	
	...
	function addSubject(sbjCd) {
		...
		$.getJSON( cUrl( "/mng/course/courseSubject/openCourseAddOnlnSbj"),
