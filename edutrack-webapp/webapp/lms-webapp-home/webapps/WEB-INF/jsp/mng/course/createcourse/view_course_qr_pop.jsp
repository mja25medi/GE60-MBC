...
<mhtml:frm_body cssTag="background-color:#fff;">
	<div class="modal_cont">
	 	<div class="dummy_box"><img src="${qrfilePath}"></div>
        <div class="enter_box">
            <input type="text" maxlength="1" class="form-control" value="${fn:substring(qrNo,0,1)}">
            <input type="text" maxlength="1" class="form-control" value="${fn:substring(qrNo,1,2)}">
            <input type="text" maxlength="1" class="form-control" value="${fn:substring(qrNo,2,3)}">
            <input type="text" maxlength="1" class="form-control" value="${fn:substring(qrNo,3,4)}">
        </div>
