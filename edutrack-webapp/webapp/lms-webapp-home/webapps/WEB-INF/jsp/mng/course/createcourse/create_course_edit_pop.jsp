		...
		<tr>
			...
			<td colspan="4">
				...
				<tr>
					...
					<td colspan="3">
						<textarea style="height:50px" dispName="<spring:message code="course.title.createcourse.info"/>" lenCheck="2000" name="creDesc" class="form-control input-sm" id="creDesc_0">${vo.creDesc }</textarea>
					</td>
				</tr>
			</table>
			<div style="width:100%;">
