			...
			<div class="col-md-12 col-xs-12 mb5">
				<div class="form-group" style="width:180px; float: left;">
					<select id="searchKey" name="searchKey" class="form-control input-sm" >
						...
						<option value="pk">수업정보코드</option>
						<!-- <option value="pkNm">수업명</option> -->
					</select>
				</div>
				<div class="input-group" style="width:180px; float: left;">
					...
					<span class="input-group-addon" onclick="listCreApiSyncResult(1)" style="cursor:pointer">
...
<script type="text/javascript">
	...
	function listCreApiSyncResult() {
		...
		$('#listCreInfoApiSync')
			.load(cUrl("/mng/etc/HrdApi/listCreApiSyncResult"),
				{ 
				  "searchKey":searchKey,
