				...
				<div class="panel panel-default">
					...
					<div class="panel-body" style="padding:0px;">
						<div style="width:100%; overflow:auto; background-color:white; padding:5px; line-height:20px; margin-top:5px;">
										...
										<c:otherwise>
											<c:forEach items="${etcApiSyncList}" var="item" varStatus="status">
												<tr>
													...
													<td class="text-center">
														<button class="btn btn-info btn-sm" type="button" onclick="javascript:callReSendUserInfoHrdApi('${item.num}','${item.userAgentPk}')">재발송</button>
													</td>
												</tr>
											</c:forEach>
										</c:otherwise>
							...
							<meditag:paging pageInfo="${pageInfo}" funcName="listUserInfoApiSync"/>
						</div>
					</div>
				</div>
...
<script type="text/javascript">
	...
	function callReSendUserInfoHrdApi(num,userAgentPk) {
		$(".overlay").show();
		$.ajax({
