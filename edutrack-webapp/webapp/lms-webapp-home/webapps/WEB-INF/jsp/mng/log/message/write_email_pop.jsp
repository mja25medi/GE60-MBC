...
<c:set var="transVO" value="${vo.logMsgTransLogVO}"/>
	...
	<form name="messageForm" id="messageForm" method="post" action="/mng/log/message/addMessage" onsubmit="return false">
		...
		<input type="hidden" name="logMsgTransLogVO.stdNoList" value="${stdNoList}"/>
