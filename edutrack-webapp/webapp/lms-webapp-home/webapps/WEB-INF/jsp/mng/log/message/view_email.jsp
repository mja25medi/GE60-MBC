...
<mhtml:body>
	...
	<div style="width:100%;height:25px;float:left">
		<div style="float:right">
        	<meditag:button value="Email 목록" title="Email 목록 화면으로 이동합니다." href="/MessageLogAdmin.do?cmd=messageMain&amp;messageDTO.msgDivCd=EMAIL&amp;curPage=${messageForm.curPage}" />
        </div>
    </div>
    <table summary="Email 정보" class="table_dtl" style="width:100%" align="center">
		...
		<tr height="35">
			...
			<th class="top" scope="row">발신자 Email</th>
			<td class="top">
				${messageDTO.sendAddr}
			</td>
...
function listMessageTrans(curPage) {
	...
	$.getJSON( cUrl("/MessageLogAdmin.do"),	// url
			...
			function (result) {
				...
				if(list.length == 0) {
					listStr +="	<tr><td colspan='6' align='center' class='b_td02'><font color=blud>* 등록된 EMAIL 발송 로그가 없습니다.</font></td></tr>\n";
				}
