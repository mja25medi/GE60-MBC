		...
		<div class="box">
			<div class="box-body">
						<div class="well well-sm">
							<form name="statsLoginForm" id="statsLoginForm" onsubmit="return false" >
...
<%-- 											<button class="btn btn-default btn-sm" onclick="listStatus()"><spring:message code="button.search"/></button> --%>
						...
						<div class="row">
							<div class="col-md-7 col-sm-7">
								<div class="panel panel-default">
									<div class="panel-heading">
										<spring:message code="log.title.loginlog.title.count"/>
									</div>
							...
							<div class="col-md-5 col-sm-5">
								<div class="panel panel-default">
									<div class="panel-heading">
										<spring:message code="log.title.loginlog.title.ratio"/>
									</div>
									<div class="panel-body" style="height:630px;">
										<div class="flot-chart">
...
<script type="text/javascript">
	...
	function listStatus() {
		//if(!validate(document.statsLoginForm)) return;
	    var f = document.statsLoginForm;
		$('#statsLoginForm').attr("action" , "/mng/stats/conn/listLogin");
		$('#statsLoginForm').ajaxSubmit(processListStatusCallback);
	}
	...
	function processListStatusCallback(resultListVO) {
		...
		var totCnt = 0;
		var ticksString = "[";
		var barDataString = "[{label:'Login',data:[";
...
//		                    formatter: "%p.0%, %s",
	...
	function dateSetter(str) {
		if(!validate(document.statsLoginForm)) return;
		$('#statsLoginForm').attr("action", "/mng/stats/conn/viewAutoDate");
		$('#statsLoginForm').find('input[name=dateType]').val(str);
		$('#statsLoginForm').ajaxSubmit(autoDateCallback);
	}
	
	function autoDateCallback(ProcessResultDTO) {
		//var Item = ProcessResultDTO.returnDto;
		var Item = ProcessResultDTO;
		$('#statsLoginForm').find('input[name=startDt]').val(Item.startDt);
		$('#statsLoginForm').find('input[name=endDt]').val(Item.endDt);
		listStatus();
	}
	...
	function excelDownload() {
		...
		$("#statsLoginForm").attr("action", '/mng/stats/conn/loginListExcelDownload');
