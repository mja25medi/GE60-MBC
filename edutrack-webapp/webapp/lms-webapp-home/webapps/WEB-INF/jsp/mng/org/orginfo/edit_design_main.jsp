		...
		<div class="box">
			<div class="box-body">
					...
					<%-- 		<li><a href="//mng/org/userInfoCfg/editCfgMain"><spring:message code="org.title.orginfo.orgdata.manage"/></a></li>
						  		...
						  		<li class="active"><a href="/mng/org/orgInfo/editDesignMain"><spring:message code="org.title.orginfo.design.manage"/></a></li>
							...
							<table summary="<spring:message code="org.title.orginfo.defaultinfo"/>" class="table table-bordered wordbreak">
								...
								<tr>
									...
									<td>
										...
										<c:if test="${vo.colorTplCd eq '002'}"><p><spring:message code="org.message.imginfo.size.main"  arguments="215|50"  argumentSeparator="|"/></p></c:if>
										...
										<c:if test="${vo.colorTplCd eq '004'}"><p><spring:message code="org.message.imginfo.size.main"  arguments="200|50"  argumentSeparator="|"/></p></c:if>
										<c:if test="${vo.colorTplCd eq '005'}"><p><spring:message code="org.message.imginfo.size.main"  arguments="200|50"  argumentSeparator="|"/></p></c:if>
								...
								<tr>
									...
									<td>
										<p><spring:message code="org.message.imginfo.size.main"  arguments="200|50"  argumentSeparator="|"/></p>
										<div class="upload">
											<div class="upload_inbox">
...
<script type="text/javascript">
	...
	function process(cmd) {
		...
		$('#orgInfoForm').attr("action", "/mng/org/orgInfo/" + cmd);
	...
	function imgWrite(imgTypeCd) {
		...
		var addContent  = "<iframe id='addImgInfoFrame' name='addImgInfoFrame' width='100%' height='100%' "
			+ "frameborder='0' scrolling='auto' src='<c:url value="/mng/org/imgInfo/addForm"/>"
	...
	function imgEdit(imgTypeCd, imgSn) {
		ItemVO.workType = imgTypeCd;
		var colorTplCd = $(':input:radio[name=colorTplCd]:checked').val();
		var addContent  = "<iframe id='editImgInfoFrame' name='editImgInfoFrame' width='100%' height='100%' "
			+ "frameborder='0' scrolling='auto' src='<c:url value="/mng/org/imgInfo/editForm"/>"
...
// 	function closeWrite() {
// 		document.location.href = cUrl("/mng/org/orginfo/main.do")
// 	}
