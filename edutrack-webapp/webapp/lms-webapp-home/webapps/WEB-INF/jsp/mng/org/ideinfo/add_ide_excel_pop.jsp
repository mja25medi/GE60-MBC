...
<c:set var="gubun" value="${gubun}"/>
	<form id="ideAddForm" name="ideAddForm" onsubmit="return false" action="/mng/org/ideInfo">
	<div class="well">
		...
		<table style="width:100%; margin-top:15px;border-top:1px solid gray">
			<tr>
				<td style="padding-top:10px;">
					<spring:message code="common.title.upload.file"/> : <a href="javascript:uploderclick('ideUploader');" class="btn btn-primary btn-xs"><spring:message code="button.select.file"/></a>
					<input type="file" name="ideUploader" id="ideUploader" style="display:none" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"/><%-- 첨부파일 버튼 --%>
				</td>
			</tr>
			<tr>
				<td style="padding-top:10px;">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
	    ...
	    $('#ideUploader').fileupload({
	        ...
	        formData : {"fileDir":fileDir, "organization":"${USER_ORGCD}","type":"excel"},
	    		...
	    		$.ajax({
	    			url : '/mng/org/ideInfo/ideExcelUpload'
	    			, data : {
	...
	function downloadSample() {
		...
		var url = cUrl("/mng/org/ideInfo/sampleExcelIdeAdd");
