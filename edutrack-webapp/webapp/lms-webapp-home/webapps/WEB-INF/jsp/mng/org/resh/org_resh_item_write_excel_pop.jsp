...
<c:set var="orgReshItemVO" value="${vo}" />
	<form id="userInfoForm" name="userInfoForm" onsubmit="return false" action="/mng/org/research/">
	<div class="well">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
	    ...
	    $('#useruploader').fileupload({
	        ...
	        formData : {"fileDir":fileDir, "organization":"${USER_ORGCD}","type":"excel"},
	        	...
	        	document.location.href = cUrl("/mng/org/research/excelUploadCheckPop")+"?fileName="+file.fileSaveNm+"${AMPERSAND}fileDir="+fileDir+"${AMPERSAND}type=excel"+"${AMPERSAND}reshSn=${orgReshItemVO.reshSn}";
			},
	...
	function downloadSample() {
		...
		var url = cUrl("/mng/org/research/sampleExcelResearchBank");
