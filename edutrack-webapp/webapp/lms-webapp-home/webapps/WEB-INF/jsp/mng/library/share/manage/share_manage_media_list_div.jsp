							...
							<c:forEach var="item" items="${clibShareMediaCntsList}">
								<li class="list-group-item">
									...
									<span class="pull-right" style="text-align: center;">
										<a href="javascript:previewMedia('${item.originCntsCd}')" class="btn btn-xs btn-default"><spring:message code="button.preview"/></a>
										<a href="javascript:manageMediaShare('${item.cntsCd}')" class="btn btn-xs btn-default"><spring:message code="button.manage"/></a>
									</span>
									<div class="small">
