...
<script type="text/JavaScript" src="/libs/kollus/cors-upload.js"></script>
	...
	<form name="clibMediaFileForm" method="post"  onsubmit="return false;">
		...
		<p id="infoVideo" style="display: none;"><spring:message code="library.message.media.upload.video.info"/></p>
		<p id="infoAudio" style="display: none;"><spring:message code="library.message.media.upload.audio.info"/></p>
...
//		document.clibMediaFileForm.action="/mng/library/clibMediaCnts/getUploadInfo";
//		document.clibMediaFileForm.method="post";
//		document.clibMediaFileForm.ajaxSubmit(processCallback);
		$('#clibMediaFileForm').attr("action","/mng/library/clibMediaCnts/getUploadInfo");
		$('#subjectForm').attr("method","post");
		$('#clibMediaFileForm').ajaxSubmit(processCallback);
	}
}
