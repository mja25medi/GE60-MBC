				...
				<div id="displayArea">
					...
					<div class="col-md-9 col-xs-18">
						<ul class="nav nav-tabs" id="tabMenuOper" style="margin-bottom: 5px;">
				  			<li class="active" id="cdnTab" ><a href="javascript:onclickTab(0)">CDN</a></li>
				  			<li id="vodTab" ><a href="javascript:onclickTab(1)">VOD</a></li>
				  			<li id="mlinkTab" ><a href="javascript:onclickTab(2)">영상링크</a></li>
						</ul>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		function moveNode(obj, str) {
            ...
            $.post(
				cUrl("/mng/library/clibShareCntsCtgr/" + cmd),
				{
					"ctgrCd" : obj.attr("ctgrCd"),
					"parCtgrCd" : obj.attr("parCtgrCd")
				},
	...
	function listPageing(page) {
		...
		if(ItemDTO.tab == "CDN" || ItemDTO.tab == "VOD" || ItemDTO.tab == "MLINK"){
			url = cUrl("/mng/library/clibShareCnts/listShareMediaCnts");
	...
	function onclickTab(tab){
		$("#cdnTab").removeClass("active");
		$("#vodTab").removeClass("active");
		$("#mlinkTab").removeClass("active");
		if(tab==0){
			$("#cdnTab").addClass("active");
			ItemDTO.tab = "CDN";
		} else if(tab==1){
			$("#vodTab").addClass("active");
			ItemDTO.tab = "VOD";
		} else if(tab==2){
			$("#mlinkTab").addClass("active");
			ItemDTO.tab = "MLINK";
		} 
		listPageing(1);
	}
