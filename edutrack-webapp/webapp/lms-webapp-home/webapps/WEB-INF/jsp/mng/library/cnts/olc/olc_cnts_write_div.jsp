...
<c:set var="curPage" value="${vo.curPage}"/>
	...
	<table summary='<spring:message code="library.title.contents.manage"/>' class="table table-striped table-bordered">
		...
		<tr>
			...
			<td>
				<input type="text" dispName="<spring:message code="library.title.contents.name"/>" maxlength="50" isNull="N" lenCheck="50" name="cntsNm" class="form-control input-sm" id="cntsNm" value="${vo.cntsNm}"/>
			</td>
		</tr>
		<tr>
