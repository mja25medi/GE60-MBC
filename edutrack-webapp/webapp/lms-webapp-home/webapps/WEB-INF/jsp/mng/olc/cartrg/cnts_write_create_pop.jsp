...
<table summary="<spring:message code="board.title.bbs.atcl.cnts"/>" class="table table-striped table-bordered" style="width:800px;">
	<colgroup>
		<col style="width: 15%"/>
		<col style="width: 85$"/>
	</colgroup>
	...
	<tr>
		<td colspan="2" style="padding:0px;">
			<textarea name="cntsCts" id="contentTextArea" title="olc.title.contents..cnts">${vo.cntsCts }</textarea>
		</td>
	</tr>
</table>
...
<script type="text/javascript">
	...
	/* 글 저장 */
	function addCnts() {
		$('#olcCartrgForm').attr("action", "/mng/olc/cartrg/addCnts");
		Editor.save();	// 다음에디터 저장.
	}

	/* 글 수정 */
	function editCnts() {
		$('#olcCartrgForm').attr("action", "/mng/olc/cartrg/editCnts");
		Editor.save();
	}
