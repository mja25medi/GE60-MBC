...
<script type="text/javascript">
	...
	function viewCnts(page) {
		...
		var url = cUrl("/mng/olc/cartrg/viewCnts")+"?olcCntsVO.cartrgCd=${olcCartrgVO.cartrgCd}&amp;olcCntsVO.cntsCd="+pageInfo;
		var addContent  = "<iframe id='viewCntsFrame' name='viewCntsFrame' width='100%' height='534px' allowtransparency='true' "
