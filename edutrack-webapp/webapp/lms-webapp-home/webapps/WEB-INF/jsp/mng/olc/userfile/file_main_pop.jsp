...
<mhtml:frm_body cssTag="background-color:#ffffff;">
	<div>
		<div id="folderDiv" style="border:1px solid #dedede;width:38%;min-height:550px;float:left;padding-top:5px;font-size:12px;"></div>
...
<script type="text/javascript">
	 ...
	 */
	function listFile() {
		var url = cUrl("/mng/olc/userFile/listFileManage")
