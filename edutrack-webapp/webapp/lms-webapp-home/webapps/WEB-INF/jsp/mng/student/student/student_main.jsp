...
<c:set var="crsCtgrCd" value="${courseVO.crsCtgrCd}"/>
				...
				<td valign="top">
					...
					<div style="width:100%; height:25px;">
						...
						<div style="float:left">
							<meditag:selectbox width="70" fieldName="creYear" formName="Search" height="100" id="creYear" onChange="listCreateCourse(1)"/>
...
<script type="text/javascript">
	...
	function categoryList() {
		...
		.jstree({
			...
			"json_data" : {
				"ajax" : {
					"url" : cUrl("/CourseCategoryAdmin.do"),
					"data" : function (n) {
						return {
							"cmd" : "listCategoryJsTree",
							"id" : n.attr ? n.attr("id") : ""
						};
					}
				}
	...
	function listCourse() {
		...
		$.getJSON(
			cUrl("/CourseCreateCourseAdmin.do"),		// url
			{ "cmd" : "listCourseJson",
