                                        ...
                                        <form id="asmtSubForm" name="asmtSubForm" onsubmit="return false"> 
	                                        ...
	                                        <tr height="35">
	                                            ...
	                                            <td class="top" colspan="3">
	                                                <input type="number" style="width:50px;float:left;" name="score" id="asmtSubScore" class="form-control input-sm" onkeyup="isChkMaxNumber(this,100)" onblur="isChkScore(this,100)">
