...
<c:set var="subjectList" value="${subjectList}"/>
	...
	<div class="text-right">
		<a class="btn btn-primary btn-sm" href="javascript:examWrite();"><spring:message code="button.write.exam"/></a>
	</div>
...
<script type="text/javascript">
	...
	function examWrite() {
		...
		parent.modalBox.setTitle("<spring:message code="lecture.title.exam.write"/>");
	...
	function examEdit(examSn) {
		...
		parent.modalBox.addContents(addContent);
		parent.modalBox.resize(700, 600);
		parent.modalBox.setTitle("<spring:message code="lecture.title.exam.edit"/>");
		parent.modalBox.show();
	}
