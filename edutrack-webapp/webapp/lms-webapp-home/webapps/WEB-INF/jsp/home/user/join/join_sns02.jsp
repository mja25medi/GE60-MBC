										...
										<c:if test="${cfgItem.requiredYn eq 'N'}"><c:set var="isNull" value="Y" /></c:if>
                                            ...
                                            <li <c:if test="${cfgItem.useYn eq 'N'}">style="display:none;"</c:if>>
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="form-row">
                                                            <input class="form-control w50" name="userNm" type="text" id="userNm" value="${joinUsrUserInfoVO.userNm }">
                                                        </div>
                                                    </div>
                                                </div>
                                            </li>
                                            ...
                                            <li <c:if test="${cfgItem.useYn eq 'N'}">style="display:none;"</c:if>>	
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="form-row">
                                                            <input class="form-control w50" type="text" name="birth" id="birth" value="${joinUsrUserInfoVO.birth }" maxlength="8" placeholder="생년월일 8자리">
                                                        </div>
                                            ...
                                            <li <c:if test="${cfgItem.useYn eq 'N'}">style="display:none;"</c:if>>
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="form-inline">
                                                        <select class="form-select w20 mr20" id="mobileNo1">
                                                        ...
                                                        <input class="form-control mr5" type="text" name="title" value="${fn:substring(joinUsrUserInfoVO.mobileNo,3,7) }" id="mobileNo2" title="전화번호 두번째자리">
			                                            <input class="form-control" type="text" name="title" value="${fn:substring(joinUsrUserInfoVO.mobileNo,7,11) }" id="mobileNo3" title="전화번호 세번째자리">       
                                                        </div>
                                                    </div>
                                                </div>
                                            </li>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-10">                                            
                                                        <div class="form-inline mb10">
                                                            <input class="form-control" type="text" name="homePostNo" id="inputAddress1" placeholder="우편번호" onclick="searchAddress()"  style="background-color: white;">
