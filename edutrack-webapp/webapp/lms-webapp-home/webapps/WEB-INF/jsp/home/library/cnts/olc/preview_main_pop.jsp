...
<div class="userView">
	...
	<%-- <h4 class="modal-title" id="modal_title" style="color: ${olcNameColor}; ${styleStr}">${clibOlcPageVO.cntsNm }</h4> --%>
...
<script type="text/javascript">
	...
	function viewPage(page) {
		...
		var url = cUrl("/home/library/clibOlcCnts/viewPage")+"?cntsCd=${vo.cntsCd}&amp;pageCd="+pageInfo;
