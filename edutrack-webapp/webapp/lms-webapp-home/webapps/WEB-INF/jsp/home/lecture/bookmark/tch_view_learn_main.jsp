			                            ...
			                            <c:choose>
			                            		...
			                            		<c:choose>
				                            		<c:when test="${sbjVO.sbjType eq 'OFF'}"> <!-- 오프라인일때 -->
				                            			<c:choose>
				                            				...
				                            				<c:otherwise>
					                            				<button type="button" class="primary" onclick="viewCodingA();">강의하기</button>
				                            				</c:otherwise>
				                            			</c:choose>
				                            		</c:when>
				                            		<c:otherwise> <!-- 온라인일때 -->
				                            			<c:choose>
				                            				<c:when test="${nowTime < contentsItem.classStartTime}"><!-- 강의시간 이전 일때 -->
				                            					<button type="button" class="primary" onclick="viewCodingA();">강의보기</button>
				                            				</c:when>
				                            				<c:otherwise>
					                            				<c:choose>
			                            	...
			                            	<c:when test="${contentsItem.cntsTypeCd eq 'CODING_T'}">
	                            				<c:choose>
		                            				...
		                            				<c:otherwise>
			                            				<button type="button" class="primary" onclick="viewCodingB();">강의하기</button>
		                            				</c:otherwise>
		                            			</c:choose>  
			                            		<c:if test="${not empty contentsItem.zoomUrl}">
