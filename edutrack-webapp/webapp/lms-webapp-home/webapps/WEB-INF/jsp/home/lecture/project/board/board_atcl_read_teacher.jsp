...
<mhtml:body>
		...
		<table class="board_b">
			...
			<tbody>
				<tr>
					<td colspan="4" class="top" style="background-color:#f3f3f3">
...
<script type="text/javascript">
	...
	//목록 이동
	function goList(){
 		document.location.href = cUrl("/lec/prj/bbsAtcl/mainPrjBbsAtcl")+"?prjtSn="+ItemDTO.prjtSn;
	}
	...
	function editAtcl(){
		$('#prjBbsAtclForm')
		.attr("action","/lec/prj/bbsAtcl/editFormPrjBbsAtcl")
		.submit();
	}
	...
	function delAtcl(){
		if(confirm('게시글을 삭제하려고 합니다.\n\n삭제 하시겠습니까?')) {
			$('#prjBbsAtclForm')
			.attr("action","/lec/prj/bbsAtcl/removePrjBbsAtcl")
			.submit();
		}else{
			return;
		}
	...
	*/
	...
	function addCmnt() {
		...
		if(cmntCts.value != "")
			$('#prjBbsAtclCmntForm').attr("action","/lec/prj/bbsAtcl/addPrjBbsCmnt").submit();
	...
	function delCmnt(atclSn, cmntSn) {
		if(confirm('게시글을 삭제하려고 합니다.\n\n삭제 하시겠습니까?')) {
			$('#prjBbsAtclCmntForm')
				.attr("action","/lec/prj/bbsAtcl/removePrjBbsCmnt")
