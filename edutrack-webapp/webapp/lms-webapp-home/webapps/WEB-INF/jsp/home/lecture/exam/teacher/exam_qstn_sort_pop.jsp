...
<c:set var="itemList" value="${examQuestionList}"/>
...
<mhtml:body>
	...
	<table class="table table-bordered wordbreak">
		<caption class="sr-only"><<spring:message code="lecture.title.exam.question.manage"/>/caption>
		<colgroup>
	...
	<input type="hidden" id="lastQstnNo" name="lastQstnNo" value="${fn:length(itemList) }"/>
