					...
					<div class="col-lg-12">
						...
						<table class="table table-bordered wordbreak">
							...
							<tr>
								...
								<td><input type="text" maxlength="100" dispName="<spring:message code="lecture.title.forum.title"/>" isNull="N" lenCheck="100" name="forumTitle" value="${vo.forumTitle}" class="form-control input-sm"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><textarea style="height:120px;" dispName="<spring:message code="lecture.title.forum.desc"/>" isNull="N" name="forumCts" cols="100" rows="25" class="form-control input-sm" >${vo.forumCts}</textarea></td>
							</tr>
						</table>
						</form>
					</div>
				...
				<div class="row" style="margin-bottom:20px;">
					<div class="col-lg-12">
						<div class="text-right">
							<a href="#" onclick="addForum()" class="btn btn-primary btn-sm"><spring:message code="button.add"/></a>
							<a href="<c:url value="/lec/forum/main"/>" class="btn btn-default btn-sm"><spring:message code="button.cancel"/></a>
						</div>
					</div>
				</div>
