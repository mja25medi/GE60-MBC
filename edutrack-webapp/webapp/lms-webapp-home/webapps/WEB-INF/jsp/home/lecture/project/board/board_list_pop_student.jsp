	...
	<table class="board_a">
		...
		<c:forEach items="${prjBbsList}" var="item" varStatus="status">
			<tr>
				...
				<td>${item.useYnNm}</td>
				<td><a class="btn_org" href="#none" onclick="editPrjBbs('${item.bbsCd}');"><span>수정</span></a></td>
			</tr>
		</c:forEach>
...
<script type="text/javascript">
	...
	//게시판 등록
	function addPrjBbs() {
		location.href = cUrl("/lec/prj/bbs/addFormPrjBbsStu")+"?prjtSn="+ItemDTO.prjtSn;
	}

	//게시판 수정
	function editPrjBbs(bbsCd) {
		location.href = cUrl("/lec/prj/bbs/editFormPrjBbsStu")+"?prjtSn="+ItemDTO.prjtSn+"${AMPERSAND}bbsCd="+bbsCd;
	}
