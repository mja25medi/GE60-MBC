...
<%@ include file="/WEB-INF/jsp/mng/common/page_init.jsp" %>
							...
							<div id="olcBox" style="float:left; width:100%;margin-top:10px;">
								...
								<div id="olcContentsListArea" class="subject-area scroll_custom" ></div>
							</div>
							...
							<script type="text/javascript">
								...
								function searchShare() {
									...
									var url = cUrl("/lec/bookmark/listOlcCntsForCntsMgr");
								...
								function previewShareCnts(cntsCd) {
									var url = cUrl("/lec/bookmark/previewOlcMain?clibShareOlcCntsVO.cntsCd="+cntsCd);
