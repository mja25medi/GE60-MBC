			 ...
			 <table class="board_b">
				...
				<tr>
					...
					<td class="top" colspan="3">
						<input type="text" style="width:98%" maxlength="100" dispName="게시판 명" isNull="N" lenCheck="100" name="bbsNm" value="${vo.bbsNm}" class="text" id="bbsNm"/>
					</td>
				</tr>
				<tr>
					<th scope="row">게시판 설명</th>
					<td colspan="3">
						<textarea style="width:99%;height:100px; border: 1px solid; border-color: #DADADA" lenCheck="1000" dispName="게시판 설명" isNull="N" name="bbsDesc">${vo.bbsDesc}</textarea>
					</td>
				</tr>
				<tr>
...
<script type="text/javascript">
	...
	function addPrjBbs() {
		...
		$('#prjBbsForm').attr("action","/lec/prj/bbs/addPrjBbs");
		$('#prjBbsForm').submit();
	}
	...
	function editPrjBbs() {
		...
		$('#prjBbsForm').attr("action","/lec/prj/bbs/editPrjBbs");
		$("#prjBbsForm").submit();
	}
	...
	function removePrjBbs() {
		if(confirm("게시판 정보를 삭제하시겠습니까?")){
			$('#prjBbsForm').attr("action","/lec/prj/bbs/removePrjBbs");
			$("#prjBbsForm").submit();
		}
	}
	...
	//게시판 목록으로 이동
	function goList() {
		document.location.href = cUrl("/lec/prj/bbs/mainPrjBbs")+"?prjBbsVO.prjtSn="+ItemDTO.prjtSn;
	}
