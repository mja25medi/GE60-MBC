		...
		<table class="board_b">
			...
			<tr>
				...
				<td class="top" colspan="3">
					<input type="text" name="atclTitle" value="${vo.atclTitle}" style="width:75%; " dispName="제 목" isNull="N" lenCheck="100" maxlength="100" class="text" id="atclTitle"/>
				</td>
			</tr>
			<tr>
...
<script type="text/javascript">
	...
	function addArticle() {
		...
		$('#prjBbsAtclForm').attr("action","/lec/prj/bbsAtcl/addPrjBbsAtcl");
		Editor.save();	// 다음에디터 저장.
	}

	/* 글 수정 */
	function editArticle() {
		$('#prjBbsAtclForm').attr("action","/lec/prj/bbsAtcl/editPrjBbsAtcl");
		Editor.save();
	}
	...
	function listArticle() {
		$('#prjBbsAtclForm')
			.attr("action","/lec/prj/bbsAtcl/mainPrjBbsAtcl")
			.submit();
	}
	...
	function setForm(editor) {
		...
		$('#prjBbsAtclForm').attr("action","/lec/prj/bbsAtcl");
		$('#prjBbsAtclForm').submit();
