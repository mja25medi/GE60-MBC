...
<mhtml:class_head>
	...
	<meditag:js src="/js/message_window.js"/>
</mhtml:class_head>
<mhtml:class_body>
	<div id="content">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<c:if test="${fn:length(userInfoForm.usrUserInfoVO.birth) == 8 }">
							<c:set var="bYear" value="${fn:substring(userInfoForm.usrUserInfoVO.birth,0,4)}"/>
							<c:set var="bMonth" value="${fn:substring(userInfoForm.usrUserInfoVO.birth,4,6)}"/>
							<c:set var="bDay" value="${fn:substring(userInfoForm.usrUserInfoVO.birth,6,8)}"/>
						</c:if>
