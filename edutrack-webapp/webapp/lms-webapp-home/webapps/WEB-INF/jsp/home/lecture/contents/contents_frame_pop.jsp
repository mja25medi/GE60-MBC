...
<iframe src="<c:url value="/lec/cnts/viewCnts?bookmarkVO.sbjCd=${bookmarkVO.sbjCd}&amp;bookmarkVO.unitCd=${bookmarkVO.unitCd}"/>" id="contentsMain" name="contentsMain" marginheight="0" marginwidth="0" scrolling="auto" width="100%" height="100%" frameborder="0" style="padding:0px;"></iframe>
</body>
</html>