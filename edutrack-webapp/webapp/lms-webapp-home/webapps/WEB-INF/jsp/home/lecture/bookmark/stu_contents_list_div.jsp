                ...
                <c:forEach items="${sbjList }" var="sbjList">
		                <div class="segment">
		                    ...
		                    <div class="course_list">
								<c:if test="${sbjList.sbjCnt eq sbjList.sbjYCnt }">
 			                        <div class="item">
			                            <div class="title prog_end"><h5>과목 학습완료</h5></div>
			                            <div class="button_group">
			                                <button type="button" class="primary" onclick="listViewLearn('${sbjList.sbjCd}')">복습하기</button>
			                            </div>
			                        </div>
			                    </c:if>
			                    <c:if test="${sbjList.sbjCnt ne sbjList.sbjYCnt }">    
			                        <div class="item">
			                            <div class="title prog_ing"><h5>과목 학습중</h5></div>
			                            <div class="button_group">
			                                <button type="button" class="primary" onclick="listViewLearn('${sbjList.sbjCd}')">학습하기</button>
			                            </div>
			                        </div>
		                        </c:if>
		                    </div>
