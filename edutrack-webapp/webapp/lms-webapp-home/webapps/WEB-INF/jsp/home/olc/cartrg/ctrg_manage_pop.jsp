...
<body style="padding-top: 0px;">
	...
	<div style="width:100%;margin-bottom:5px;" class="text-right">
		<a href="javascript:addCtgr()" class="btn btn-primary btn-sm">등록</a>
...
<script type="text/javascript">
	...
	function addCtgr(){
		document.location = "/home/olc/cartrg/addCtrgForm";
	}

	function editCtgr(ctgrCd){
		document.location = "/home/olc/cartrg/editCtrgForm?ctgrCd="+ctgrCd;
	}
</script>
</body>
</mhtml:home_html>
