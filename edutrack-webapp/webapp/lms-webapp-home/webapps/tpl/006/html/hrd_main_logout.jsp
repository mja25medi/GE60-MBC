...
<html lang="ko">
	...
	<body>
		<div id="wrap">
			<%@ include file="../inc/hrd_header_logout.jsp" %>
						...
						<div class="login_wrap">
							<div class="con">
								...
								<div class="login_form after_login">
									<div class="welcom"><strong>홍길동</strong>님 반갑습니다.</div>
									<div class="login_bottom">
										<ul>
											<li>
												<a href="#" class="btn"><span>마이페이지</span></a>
											</li>
											<li>
												<a href="#" class="btn"><span>개인정보 수정</span></a>
											</li>
										</ul>
									</div>
									<div class="entry_btn">
										<button type="submit" title="로그아웃">로그아웃</button>
									</div>
								</div>
							</div>
						</div>
									...
									<a href="#0">
										<div class="card_item">
											<div class="image_area">
												<div class="img_area">
													<img src="../img/new_main/newClass_01.png" alt="[필수교육] 의료기관 및 요양기 관 종사자 CS 교육" />
												</div>
											</div>
											<div class="des">
				...
				<div class="section section02">
					<div class="container">
						<div class="title_info">
							...
							<h2>BEST 추천 강의</h2>
							<div class="desc">오성온의 대표 강의들을 만나보세요!</div>
						</div>
						<ul class="best_list">
							<li>
								<a href="#0">
