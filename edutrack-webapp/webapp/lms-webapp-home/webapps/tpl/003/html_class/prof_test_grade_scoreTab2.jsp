...
<body>
    <div id="wrap">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td data-label="응시여부">응시</td>
                                    <td data-label="응시일시">2023.10.21 10:08</td>
                                    <td data-label="점수">100점</td>
                                    <td data-label="평가여부">-</td>
                                    <td data-label="평가/결과">-</td>
                                </tr>
                            </tbody>
        ...
        <button class="modal__btn" id="popup3">단답, 서술형 평가 팝업</button>
        <button class="modal__btn" id="popup4">평가 팝업</button>
        <button class="modal__btn" id="popup1">SMS 팝업</button>
        <button class="modal__btn" id="popup2">Email 팝업</button>
        <script type="text/javascript">
            ...
            $("#popup3").click(function() {
                $('body').css("overflow", "hidden");
                $("#test_type1").css('display','flex').hide().fadeIn();
                iFrameResize({ scrolling: true }, '#iframe3')
            })

            $("#popup4").click(function() {
                $('body').css("overflow", "hidden");
                $("#test_type2").css('display','flex').hide().fadeIn();
                iFrameResize({ scrolling: true }, '#iframe4')
            })
        </script>
        <!-- 단답, 서술형 평가 popup -->
        <div id="test_type1" class="modal_popup_wrap">                             
            <div class="modal_popup modal_wide">
                <h4 class="modal_title">단답, 서술형 평가</h4>
                <iframe id="iframe3" src="iframe_test_type1.jsp"></iframe>
                <button type="button" class="modal_close"><i class="xi-close-thin"></i><span class="sr-only">팝업닫기</span></button>
            </div>
        </div>

        <!-- 평가 popup -->
        <div id="test_type2" class="modal_popup_wrap">                             
            <div class="modal_popup modal_wide">
                <h4 class="modal_title">평가</h4>
                <iframe id="iframe4" src="iframe_test_type2.jsp"></iframe>
                <button type="button" class="modal_close"><i class="xi-close-thin"></i><span class="sr-only">팝업닫기</span></button>
            </div>
        </div>
        ...
        <div id="send_sms" class="modal_popup_wrap">                             
            <div class="modal_popup modal_medium">
                ...
                <iframe id="iframe1" src="iframe_send_sms.jsp"></iframe>
                <button type="button" class="modal_close"><i class="xi-close-thin"></i><span class="sr-only">팝업닫기</span></button>
            </div>
        </div>
        <!-- 메일 popup -->
        <div id="send_email" class="modal_popup_wrap">                             
            <div class="modal_popup modal_medium">
                ...
                <iframe id="iframe2" src="iframe_send_email.jsp"></iframe>
                <button type="button" class="modal_close"><i class="xi-close-thin"></i><span class="sr-only">팝업닫기</span></button>
            </div>
        </div>
        <!-- //modal popup -->
