            ...
            <ul class="dbody">
                ...
                <li>
                    <div class="row">
                        ...
                        <div class="col-sm-10">학습자3(medistu3@gamil.com), 학습자2(medistu2@daum.net), 학습자3(medistu1@naver.com)</div>
                    </div>
                </li>
                <li>
                    <div class="row">
                ...
                <li>
                    <div class="row">
                        <label for="attchFile" class="form-label col-sm-2">첨부파일</label>
