                ...
                <div class="segment">
                    <div class="res_tbl_wrap">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td scope="row" class="title" data-label="과정명">파이썬 설치 및 강의 환경 설정</td>
                                    <td data-label="시험">40</td>
                                    <td data-label="진행단계평가">30</td>
                                    <td data-label="총점">70</td>
                                    <td data-label="수료여부">수강승인</td>
                                    <td data-label="이의제기"><button class="btn-line">이의제기</button></td>
                                </tr>
                                <tr>
                                    <td scope="row" class="title" data-label="과정명">변수 네이밍 규칙</td>
                                    <td data-label="시험">40</td>
                                    <td data-label="진행단계평가">30</td>
                                    <td data-label="총점">70</td>
                                    <td data-label="수료여부">수강승인</td>
