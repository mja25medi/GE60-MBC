                                ...
                                <a href="#0">
                                    <div class="card_item">
                                        <div class="image_area">
                                            <div class="img_area">
                                                <img src="../img/contents/thumb_01.png" alt="실무에 바로 적용하는 엑셀 2023">
                                            </div>
                                        </div>
                                        <div class="des">
                            ...
                            <li>
                                <a href="#0">
                                    <div class="card_item">
                                        <div class="image_area">
                                            <div class="img_area">
                                                <img src="../img/contents/thumb_02.png" alt="[공공특화] 공공데이터 분석에서 보고서 작성까지 All in One">
                                            </div>
                                        </div>
                                        <div class="des">
                            ...
                            <li>
                                <a href="#0">
                                    <div class="card_item">
                                        <div class="image_area">
                                            <div class="img_area">
                                                <img src="../img/contents/thumb_03.png" alt="(신규)MBTI 심리상담지도자 2급과정">
                                            </div>
                                        </div>
                                        <div class="des">
                            ...
                            <li>
                                <a href="#0">
                                    <div class="card_item">
                                        <div class="image_area">
                                            <div class="img_area">
                                                <img src="../img/contents/thumb_04.png" alt="사회지도자 전문교육과정">
                                            </div>
                                        </div>
                                        <div class="des">
                            ...
                            <li>
                                <a href="#0">
                                    <div class="card_item">
                                        <div class="image_area">
                                            <div class="img_area">
                                                <img src="../img/contents/thumb_05.png" alt="테마로 보는 서양미술의 흐름">
                                            </div>
                                        </div>
                                        <div class="des">
                    ...
                    <ul class="best_list">
                        ...
                        <li>
                            <a href="#0">
                                <div class="card_item">                                    
                                    <div class="img_area">
                                        <img src="../img/main/best_03.png" alt="지능형 Full-Stack IoT 전문가과정">
                                    </div>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="#0">
                                <div class="card_item">                                    
                                    <div class="img_area">
                                        <img src="../img/main/best_04.png" alt="빅데이터">
                                    </div>
                                </div>
                            </a>
                        </li>
