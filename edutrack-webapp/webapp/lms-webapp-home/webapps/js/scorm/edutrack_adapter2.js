...
function EdutrackAPIAdapter() {
	...
	this.SetPausedTime					= ApiSetPausedTime;
...
function ApiCommit(parameter) {
	...
	else if(parameter == "" || parameter == "fin") {
		if (this.isInitialized == true) {
			// credit 인 경우만 저장
			if (this.credit == "credit") {
				...
				console.log("contm1",(this.endTime - this.startTime ) * 0.6);
				console.log("pausedTime",this.pausedTime);
				console.log("contm2",((this.endTime - this.startTime ) * 0.6) -this.pausedTime);
				...
				this.BookmarkDTO.connTotTm = parseInt(this.BookmarkDTO.connTotTm,10) + parseInt(this.BookmarkDTO.connTm,10) - this.pausedTime;
				...
				if(this.bookmarkType == "PAGE") {
					...
					if(this.showTime == "" || this.showTime == "0" || parameter == "fin") {
						...
						if(ratio > 100) this.BookmarkDTO.prgrRatio = 100;
						else this.BookmarkDTO.prgrRatio = ratio;
					}
				}
...
function ApiSetPausedTime(pausedTime) {
