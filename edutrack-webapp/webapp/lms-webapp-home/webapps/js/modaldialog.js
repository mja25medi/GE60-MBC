...
$M.ModalDialog.prototype = {
	initModal :
		function() {
			...
			if(!this.data.nomargin) {
				divcontents =
					"<div class='modal fade' id='"+modalid+"' tabindex='-1' data-backdrop='"+modalYn+"' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>"+
					"	<div class='modal-dialog' style='width:"+width+"px;' id='"+modalid+"_box'>"+
					"		<div class='modal-content'>"+
					"			<div class='modal-header'>"+
					"				<button type='button' class='close' data-dismiss='modal' aria-hidden='true'>×</button>"+
					"				<h4 class='modal-title' id='"+modalid+"_title' style='text-overflow:ellipsis;white-space:nowrap;word-wrap:normal;overflow:hidden;'>"+title+"</h4>"+
					"			</div>"+
				...
				divcontents =
					"<div class='modal' id='"+modalid+"' tabindex='-1' data-backdrop='"+modalYn+"' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>"+
					"	<div class='modal-dialog' style='width:"+width+"px;' id='"+modalid+"_box'>"+
					"		<div class='modal-content'>"+
					"			<div class='modal-body' style='padding:5px;height:"+height+"px;' id='"+modalid+"_body'>"+
					"			</div>"+
					"		</div>"+
					"	</div>"+
					"</div>";
	...
	move :
		function(posx, posy) {
			$("#"+this.data.modalid+"_box").css("position","absolute");
			$("#"+this.data.modalid+"_box").css("top",posx+"px");
			$("#"+this.data.modalid+"_box").css("left",posy+"px");
		},
	moveCenter :
		function() {
			$("#"+this.data.modalid+"_box").css("position","relative");
		},
	show :
		function() {
