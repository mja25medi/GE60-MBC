...
<%
	...
	*/
	...
	//String siteDomain = "https://localhost"; //가맹점 도메인 입력
									...
									<td style="text-align:left;">
										<form id="SendPayForm_id" name="" method="POST" >
											...
											<div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
												...
												<br/><b>returnUrl</b> :
												<br/><input  style="width:100%;" name="returnUrl" value="<%=siteDomain%>/inicis/INIStdPayReturn.jsp" >
												<!--
											...
											<div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
												...
												<br/><input style="width:100%;" name="closeUrl" value="<%=siteDomain%>/inicis/close.jsp" >
												...
												<br/><input style="width:100%;" name="popupUrl" value="<%=siteDomain%>/inicis/popup.jsp" >
