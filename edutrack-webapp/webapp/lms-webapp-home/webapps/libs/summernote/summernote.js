...
(function (factory) {
  ...
  var editable = renderer.create('<div class="note-editable panel-body wordbreak" contentEditable="true"/>');
  ...
  var LinkDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group">' +
                   ...
                   '<input style="width:100%;" class="note-link-text form-control" type="text" />' +
                 '</div>' +
                 '<div class="form-group">' +
                   '<label>' + lang.link.url + '</label>' +
                   '<input style="width:100%;" class="note-link-url form-control" type="text" value="http://" />' +
                 '</div>' +
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group note-group-select-from-files">' +
                   ...
                   '<input style="width:100%;" class="note-image-input form-control" type="file" name="files" accept="image/*" multiple="multiple" style="height:40px" />' +
                   imageLimitation +
                 '</div>' +
                 '<div class="form-group" style="overflow:auto;">' +
                   '<label>' + lang.image.url + '</label>' +
                   '<input style="width:100%;" class="note-image-url form-control col-md-12" type="text" />' +
                 '</div>';
  ...
  var VideoDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group row-fluid">' +
          ...
          '<input style="width:100%;" class="note-video-url form-control span12" type="text" />' +
          '</div>';
